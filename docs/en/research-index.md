...
| rUGP object and image behavior | rugptools / alterdec prediction rules and disassembly of muzhi's RioX 1.2.143.810 | PF/PM parsing, encoding and integration; see the [detailed provenance and technical blueprint (Chinese)](../research/photon/README.md) | Specific reference behavior is distinguished from copied code; unresolved historical licensing is not treated as redistribution permission |
