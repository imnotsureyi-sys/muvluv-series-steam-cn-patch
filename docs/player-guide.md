...
[简体中文](player-guide.zh-CN.md) · [Player downloads](../README.md#player-downloads) · [Report a bug](https://github.com/imnotsureyi-sys/muvluv-series-steam-cn-patch/issues/new?template=bug-report.yml)
...
Future packages are expected to carry a complete install manifest and tested rollback path under the current [release process](release-process.md).
