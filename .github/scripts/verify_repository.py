...
REQUIRED = {
    ...
    "AGE2/evidence/translations/review-ledger/pending.csv",
    "AGE2/evidence/translations/review-ledger/manifest.json",
    "AGE2/games/README.md",
    "AGE2/games/tda00/images/release-inventory.json",
    "AGE2/games/tda01/images/release-inventory.json",
    "AGE2/games/tda02/images/release-inventory.json",
    "AGE2/games/tda03/images/release-inventory.json",
    "AGE2/games/imperial-capital-burns/images/release-inventory.json",
    ...
    "rUGP/games/README.md",
    "rUGP/evidence/photon/README.md",
    "rUGP/evidence/photon/images/manifest.json",
    "rUGP/evidence/photon/routes/routes.json",
    "rUGP/evidence/photon/text/reviewed/manifest.json",
}
