...
For the broader map from public prior work to project-specific findings, see the [research index](../../../docs/research-index.md), [provenance policy](../provenance.md), and [quality gates](../quality.md).
