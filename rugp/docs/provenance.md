...
`evidence/photon-text-v1/manifest.json` and a clean-checkout regression test.

The separate [57,547-row reviewed-text evidence](../evidence/photon-reviewed-text-v1/README.md) preserves the wider translation work for review and other locales without pretending those rows have already been bound to a writer/runtime route.
