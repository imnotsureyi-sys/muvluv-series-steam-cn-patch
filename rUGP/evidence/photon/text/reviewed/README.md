...
精确写入契约仍由各自 `text-data/runtime/zh-Hans.csv` 负责。

| 公开表 | 行数 |
| --- | ---: |
| [Photon Flowers / Alternative](../../../../games/photonflowers/text-data/history/reviewed/alternative.zh-Hans.csv) | 6,033 |
| [Photon Flowers / Extra](../../../../games/photonflowers/text-data/history/reviewed/extra.zh-Hans.csv) | 6,931 |
| [Photon Melodies / Adoration + Resurrection](../../../../games/photonmelodies/text-data/history/reviewed/adoration-resurrection.zh-Hans.csv) | 8,407 |
| [Photon Melodies / Shard of Spacetime](../../../../games/photonmelodies/text-data/history/reviewed/shard-of-spacetime/) | 36,176 |
