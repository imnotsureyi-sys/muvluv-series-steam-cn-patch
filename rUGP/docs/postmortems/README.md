...
| [CRsa full-field audit](crsa-native-text-20260903.md) and [native-field increment](crsa-native-increment-20260904.md) | Which PF/PM text fields were omitted beyond the first 40 display gaps, and how are the reviewed fields rebound? | Sequential native parsing of all 466 original CRsa records and 22 current overrides, source-hash checks for 57,547 reviewed rows, reviewed manifests and strict writeback/readback tests | Static coverage and runtime sampling have separate evidence boundaries; generated game resources do not enter Git |
